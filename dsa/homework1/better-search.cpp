...
static void betterSearch( const AlignedIntArray &hayStack, const AlignedIntArray &needles, AlignedIntArray &indices, StackAllocator &allocator)
{
	...
	const int m = needles.getCount();
	const int LINEAR_SEARCH_MIN = 8;
...
// void blabla(const std::vector<int>& hayStack, const std::vector<int>& needles, std::vector<int>& indices)
// {
//     const int* data = hayStack.get();
//     const int n = hayStack.getCount();
// 	   const int m = needles.getCount();
